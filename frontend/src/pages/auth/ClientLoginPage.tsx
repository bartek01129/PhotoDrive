...
export function ClientLoginPage() {
	...
	return (
		<div className='min-h-screen w-full flex'>
			{/* Left: Cinematic hero */}
			<div className='hidden lg:block lg:w-1/2 relative overflow-hidden bg-surface-dim'>
				<div className='absolute inset-0 bg-gradient-to-r from-background/80 to-background' />
				<div className='absolute bottom-16 left-12 right-12'>
					...
					<p className='font-display text-6xl text-on-surface/80 leading-[0.9]'>
						Twoje
						<br />
						<span className='italic'>wspomnienia.</span>
					</p>
				</div>
			</div>
